...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var app_ui__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! app/ui */ \"./app/ui.ts\");\n/* harmony import */ var app_htmlElements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! app/htmlElements */ \"./app/htmlElements.ts\");\n/* harmony import */ var app_date__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! app/date */ \"./app/date.ts\");\n/* harmony import */ var app_task__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! app/task */ \"./app/task.ts\");\n// import { testInputs } from 'app/development/testInput';\r\n// import { DataBase } from 'app/dataBase';\r\n// import { taskHandler } from 'app/taskHandler';\r\n// import { scheduleTasks } from 'app/schedule';\r\n\r\n\r\n\r\n\r\nlet dataBase = {\r\n    content: [],\r\n    subjects: [],\r\n    nextId: 1\r\n};\r\nlet schedule = {\r\n    content: []\r\n};\r\nlet taskList = {\r\n    mustDo: [],\r\n    toDo: []\r\n};\r\nlet currentTaskId = 0;\r\nconst now = (0,app_date__WEBPACK_IMPORTED_MODULE_2__.getCurrentTime)();\r\nconsole.log(now);\r\nconsole.log((0,app_date__WEBPACK_IMPORTED_MODULE_2__.numberToDateString)(now));\r\nconsole.log((0,app_date__WEBPACK_IMPORTED_MODULE_2__.dateStringToNumber)((0,app_date__WEBPACK_IMPORTED_MODULE_2__.numberToDateString)(now)));\r\nconsole.log((0,app_date__WEBPACK_IMPORTED_MODULE_2__.numberToDateString)((0,app_date__WEBPACK_IMPORTED_MODULE_2__.dateStringToNumber)((0,app_date__WEBPACK_IMPORTED_MODULE_2__.numberToDateString)(now))));\r\nfunction hideTaskEditWindow() {\r\n    app_htmlElements__WEBPACK_IMPORTED_MODULE_1__.taskEditWindow.divs.main.style.display = 'none';\r\n}\r\nfunction showTaskEditWindow() {\r\n    app_htmlElements__WEBPACK_IMPORTED_MODULE_1__.taskEditWindow.divs.main.style.display = 'block';\r\n}\r\napp_htmlElements__WEBPACK_IMPORTED_MODULE_1__.createNewTask.onclick = () => {\r\n    const newTask = (0,app_task__WEBPACK_IMPORTED_MODULE_3__.initTask)();\r\n    currentTaskId = newTask.id;\r\n    (0,app_task__WEBPACK_IMPORTED_MODULE_3__.insertTaskValue)(newTask);\r\n    showTaskEditWindow();\r\n};\r\napp_htmlElements__WEBPACK_IMPORTED_MODULE_1__.taskDBList.onclick = () => {\r\n    let taskIndex = [...app_htmlElements__WEBPACK_IMPORTED_MODULE_1__.taskDBList.children].indexOf(event === null || event === void 0 ? void 0 : event.target);\r\n    // schinanigins\r\n    taskIndex = (taskIndex - 1) / 2;\r\n    console.log(taskIndex);\r\n    currentTaskId = dataBase.content[taskIndex].id;\r\n    console.log(dataBase.content[taskIndex]);\r\n    (0,app_task__WEBPACK_IMPORTED_MODULE_3__.insertTaskValue)(dataBase.content[taskIndex]);\r\n    showTaskEditWindow();\r\n};\r\napp_htmlElements__WEBPACK_IMPORTED_MODULE_1__.taskEditWindow.buttons.save.onclick = () => {\r\n    hideTaskEditWindow();\r\n    const task = (0,app_task__WEBPACK_IMPORTED_MODULE_3__.getTaskValue)((0,app_task__WEBPACK_IMPORTED_MODULE_3__.getTaskById)(currentTaskId, dataBase));\r\n    if (currentTaskId === 0) {\r\n        task.id = dataBase.nextId;\r\n        dataBase.nextId++;\r\n        dataBase.content.push(task);\r\n    }\r\n    else {\r\n        dataBase.content[(0,app_task__WEBPACK_IMPORTED_MODULE_3__.getTaskIndexById)(currentTaskId, dataBase)] = task;\r\n    }\r\n    updateTaskDBDisplay();\r\n};\r\napp_htmlElements__WEBPACK_IMPORTED_MODULE_1__.taskEditWindow.buttons.cancel.onclick = () => {\r\n    hideTaskEditWindow();\r\n};\r\napp_htmlElements__WEBPACK_IMPORTED_MODULE_1__.taskEditWindow.buttons[\"delete\"].onclick = () => {\r\n    hideTaskEditWindow();\r\n    if (currentTaskId > 0) {\r\n        dataBase.content.splice((0,app_task__WEBPACK_IMPORTED_MODULE_3__.getTaskIndexById)(currentTaskId, dataBase));\r\n    }\r\n    updateTaskDBDisplay();\r\n};\r\nfunction updateTaskDBDisplay() {\r\n    (0,app_ui__WEBPACK_IMPORTED_MODULE_0__.displayTaskList)(dataBase.content, app_htmlElements__WEBPACK_IMPORTED_MODULE_1__.taskDBList);\r\n}\r\nfunction updateTaskEditWindowDisplay() {\r\n    const tewi = app_htmlElements__WEBPACK_IMPORTED_MODULE_1__.taskEditWindow.inputs;\r\n    const tewd = app_htmlElements__WEBPACK_IMPORTED_MODULE_1__.taskEditWindow.divs;\r\n    // fix so we change value of container instead of input itself\r\n    if (tewi.isEvent.checked) {\r\n        tewi.isDone.style.display = 'none';\r\n    }\r\n    else {\r\n        tewi.isDone.style.display = 'block';\r\n    }\r\n    if (tewi.isSchedule.checked) {\r\n        tewd.schedule.style.display = 'block';\r\n        if (tewi.isRepeating.checked) {\r\n            tewd.repeat.style.display = 'block';\r\n            if (tewi.isRepeatEnd.checked) {\r\n                tewi.repeatEnd.style.display = 'block';\r\n            }\r\n            else {\r\n                tewi.repeatEnd.style.display = 'none';\r\n            }\r\n        }\r\n        else {\r\n            tewd.repeat.style.display = 'none';\r\n        }\r\n    }\r\n    else {\r\n        tewd.schedule.style.display = 'none';\r\n    }\r\n}\r\nfunction update() {\r\n    updateTaskEditWindowDisplay();\r\n}\r\nsetInterval(update, 20);\r\n\n\n//# sourceURL=webpack://alttp/./app/client.ts?");
